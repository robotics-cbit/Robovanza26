...
export default function RoboWars() {
  return (
    <Layout>
      <section className="relative min-h-[70vh] sm:min-h-[80vh] md:min-h-[85vh] lg:min-h-[90vh] bg-[url('/Robowars.png')] bg-cover bg-center flex flex-col">
        <Link
          href="/"
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="bg-white/35 backdrop-blur-s px-4 py-4 sm:px-6 sm:py-6 md:px-8 md:py-7 lg:px-10 lg:py-8 rounded-full text-center min-w-[80vw] sm:min-w-[70vw] md:min-w-[60vw] lg:min-w-[50vw] max-w-4xl">
            ...
            <p className="exo-2-regular text-sm sm:text-lg md:text-xl lg:text-2xl">
              THE ULTIMATE CLASH OF STEEL AND STRATEGY
            </p>
          </div>
        </div>
      ...
      <section className="bg-black text-white py-2 sm:py-2.5 md:py-3 overflow-hidden">
        <p className="exo-2-bold text-center tracking-widest text-xs sm:text-sm md:text-base">
          HALT OR BE HALTED <span className="max-sm:hidden">• HALT OR BE HALTED</span><span className="max-xl:hidden"> • HALT OR BE HALTED • HALT OR BE HALTED</span>
        </p>
      </section>

      <section className="bg-[url(/EventsBg.png)] bg-cover py-8 sm:py-12 md:py-14 lg:py-16 text-white px-4">
        <h2 className="exo-2-bold text-2xl sm:text-3xl md:text-4xl text-center mb-8 sm:mb-10 md:mb-12">
          TOTAL PRIZE POOL :<br/> ₹ 50,000
        </h2>

        <div className="flex flex-col md:flex-row gap-10 sm:gap-14 md:gap-16 lg:gap-20 justify-center items-end">
          <div className="relative mx-auto">
              <Image
                ...
                width={390}
                height={390}
                className="object-contain w-[280px] sm:w-[320px] md:w-[350px] lg:w-[390px] h-auto"
              />
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
                <p className="exo-2-bold mt-12 sm:mt-16 md:mt-18 lg:mt-20 text-3xl sm:text-3xl md:text-4xl">Beetleweight</p>
                <p className="exo-2-regular text-2xl sm:text-2xl md:text-3xl mb-2 sm:mb-3 md:mb-4">category</p>
                <p className="exo-2-bold text-2xl sm:text-2xl md:text-3xl">3lbs (1.36kg approx.)</p>
              </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[url(/EventsBg.png)] bg-cover py-8 sm:py-12 md:py-14 lg:py-16 text-white px-4 sm:px-6">
        ...
        <ul className="max-w-4xl mx-auto space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6 text-base sm:text-lg md:text-xl lg:text-2xl exo-2-regular list-disc list-inside bg-darkblue-20 p-4 sm:p-6 md:p-8 rounded-lg border-2 sm:border-3 md:border-4 lg:border-5 border-white/30">
          <li>FORMAT: 1v1 Combat</li>
          <li>TEAM SIZE: 3 members per side</li>
          <li>ARENA: 8ft x 8ft x 4ft (l x b x h) steel cage</li>
          <li>WIN CONDITION: Halt your opponent for 10 seconds</li>
          <li>POINTS: Scored based on damage, aggression, control</li>
        </ul>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12 md:gap-14 lg:gap-16 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
              ...
              <div className="flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <Image src="/banned.png" alt="banned" width={100} height={100} className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-[100px] lg:h-[100px]" />
                <p className="exo-2-regular text-sm sm:text-base md:text-lg lg:text-xl max-w-sm">
                  BANNED: Hammers, Cutters, Fire, Nets, Pneumatics
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
              ...
              <div className="flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 flex-row lg:flex-row-reverse text-left lg:text-right">
                ...
                <p className="exo-2-regular text-sm sm:text-base md:text-lg lg:text-xl max-w-sm">
                  WEIGHT: 3lbs (1.36kg approx.)
                </p>
              </div>
              <div className="flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 flex-row lg:flex-row-reverse text-left lg:text-right">
                <Image src="/voltage.png" alt="voltage" width={100} height={100} className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-[100px] lg:h-[100px]" />
                <p className="exo-2-regular text-sm sm:text-base md:text-lg lg:text-xl max-w-sm">
                  VOLTAGE: ≤ 14.8V DC (4S)
                </p>
              </div>
