                        ...
                        <table className="w-full border-collapse table-fixed">
                            ...
                            <tbody>
                                ...
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Thriveforce-2</td>
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-bold text-yellow-400 truncate">Thriveforce-2</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Thriveforce-1</td>
                                ...
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Hydrobotz-Goutham</td>
                                ...
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-bold text-yellow-400 truncate">ESC</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    <td colSpan={4} className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-xl text-center">Round 1</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Hydrabotz-1</td>
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Hydrabotz-2</td>
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-bold text-yellow-400 truncate">Hydrabotz-1</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Thriveforce-2</td>
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Hydrabotz-Prashanth</td>
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-bold text-yellow-400 truncate">Thriveforce-2</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    ...
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">ESC</td>
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base truncate">Hydrabotz-5</td>
                                    <td className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-bold text-yellow-400 truncate">ESC</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                ...
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
                                    <td colSpan={4} className="border border-gray-600 p-1 sm:p-2 md:p-3 lg:p-4 text-[10px] sm:text-xs md:text-sm lg:text-xl text-center">Finals</td>
                                </tr>
                                <tr className="hover:bg-white/10 active:bg-white/15 transition-colors duration-200">
